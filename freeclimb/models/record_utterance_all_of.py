...
class RecordUtteranceAllOf(object):
    ...
    def __init__(self, action_url=None, silence_timeout_ms=None, finish_on_key=None, max_length_sec=None, play_beep=None, auto_start=None, local_vars_configuration=None):  # noqa: E501
        """RecordUtteranceAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action_url(self):
        """Gets the action_url of this RecordUtteranceAllOf.  # noqa: E501
        ...
        :return: The action_url of this RecordUtteranceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def action_url(self, action_url):
        """Sets the action_url of this RecordUtteranceAllOf.

        URL to which information on the completed recording is submitted. The PerCL received in response is then used to continue with Call processing.  # noqa: E501

        :param action_url: The action_url of this RecordUtteranceAllOf.  # noqa: E501
        :type: str
        """
    ...
    def silence_timeout_ms(self):
        """Gets the silence_timeout_ms of this RecordUtteranceAllOf.  # noqa: E501

        Interval of silence that should elapse before ending the recording.  # noqa: E501

        :return: The silence_timeout_ms of this RecordUtteranceAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def silence_timeout_ms(self, silence_timeout_ms):
        """Sets the silence_timeout_ms of this RecordUtteranceAllOf.

        Interval of silence that should elapse before ending the recording.  # noqa: E501

        :param silence_timeout_ms: The silence_timeout_ms of this RecordUtteranceAllOf.  # noqa: E501
        :type: int
        """
    ...
    def finish_on_key(self):
        """Gets the finish_on_key of this RecordUtteranceAllOf.  # noqa: E501

        Key that triggers the end of the recording. any digit, '#', or '*'  # noqa: E501

        :return: The finish_on_key of this RecordUtteranceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def finish_on_key(self, finish_on_key):
        """Sets the finish_on_key of this RecordUtteranceAllOf.

        Key that triggers the end of the recording. any digit, '#', or '*'  # noqa: E501

        :param finish_on_key: The finish_on_key of this RecordUtteranceAllOf.  # noqa: E501
        :type: str
        """
    ...
    def max_length_sec(self):
        """Gets the max_length_sec of this RecordUtteranceAllOf.  # noqa: E501

        Maximum length for the command execution in seconds.  # noqa: E501

        :return: The max_length_sec of this RecordUtteranceAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def max_length_sec(self, max_length_sec):
        """Sets the max_length_sec of this RecordUtteranceAllOf.

        Maximum length for the command execution in seconds.  # noqa: E501

        :param max_length_sec: The max_length_sec of this RecordUtteranceAllOf.  # noqa: E501
        :type: int
        """
    ...
    @property
    def play_beep(self):
        """Gets the play_beep of this RecordUtteranceAllOf.  # noqa: E501

        Indicates whether to play a beep sound before the start of the recording. If set to `false`, no beep is played.  # noqa: E501

        :return: The play_beep of this RecordUtteranceAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def play_beep(self, play_beep):
        """Sets the play_beep of this RecordUtteranceAllOf.

        Indicates whether to play a beep sound before the start of the recording. If set to `false`, no beep is played.  # noqa: E501

        :param play_beep: The play_beep of this RecordUtteranceAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def auto_start(self):
        """Gets the auto_start of this RecordUtteranceAllOf.  # noqa: E501
        ...
        :return: The auto_start of this RecordUtteranceAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_start(self, auto_start):
        """Sets the auto_start of this RecordUtteranceAllOf.

        If `false`, recording begins immediately after the RecordUtterance command is processed. If `true`, recording begins when audio is present and if audio begins before the `maxLengthSec` timeout. If no audio begins before `maxLengthSec`, no recording is generated.  # noqa: E501

        :param auto_start: The auto_start of this RecordUtteranceAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecordUtteranceAllOf):
            return False
