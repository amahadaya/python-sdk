...
class Enqueue(object):
    ...
    def __init__(self, action_url=None, notification_url=None, queue_id=None, wait_url=None, local_vars_configuration=None):  # noqa: E501
        """Enqueue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action_url(self):
        """Gets the action_url of this Enqueue.  # noqa: E501
        ...
        :return: The action_url of this Enqueue.  # noqa: E501
        :rtype: str
        """
    ...
    def action_url(self, action_url):
        """Sets the action_url of this Enqueue.

        A request is made to this URL when the Call leaves the Queue, which can occur if enqueue of the Call fails or when the call is dequeued via the `Dequeue` command, the REST API (POST to Queue Member resource), or the caller hangs up.  # noqa: E501

        :param action_url: The action_url of this Enqueue.  # noqa: E501
        :type: str
        """
    ...
    def notification_url(self):
        """Gets the notification_url of this Enqueue.  # noqa: E501
        ...
        :return: The notification_url of this Enqueue.  # noqa: E501
        :rtype: str
        """
    ...
    def notification_url(self, notification_url):
        """Sets the notification_url of this Enqueue.

        URL to be invoked when the call enters the queue. The request to the URL contains the standard request parameters.This is a notification only; any PerCL returned will be ignored.  # noqa: E501

        :param notification_url: The notification_url of this Enqueue.  # noqa: E501
        :type: str
        """
    ...
    @property
    def queue_id(self):
        """Gets the queue_id of this Enqueue.  # noqa: E501
        ...
        :return: The queue_id of this Enqueue.  # noqa: E501
        :rtype: str
        """
    ...
    def queue_id(self, queue_id):
        """Sets the queue_id of this Enqueue.

        ID of the Queue to which to add the Call. If the Queue does not exist, it will be created. The ID must start with QU followed by 40 hex characters.  # noqa: E501

        :param queue_id: The queue_id of this Enqueue.  # noqa: E501
        :type: str
        """
    ...
    @property
    def wait_url(self):
        """Gets the wait_url of this Enqueue.  # noqa: E501

        A request is made to this URL when the Call leaves the Queue, which can occur if enqueue of the Call fails or when the call is dequeued via the `Dequeue` command, the REST API (POST to Queue Member resource), or the caller hangs up.  # noqa: E501

        :return: The wait_url of this Enqueue.  # noqa: E501
        :rtype: str
        """
    ...
    def wait_url(self, wait_url):
        """Sets the wait_url of this Enqueue.

        A request is made to this URL when the Call leaves the Queue, which can occur if enqueue of the Call fails or when the call is dequeued via the `Dequeue` command, the REST API (POST to Queue Member resource), or the caller hangs up.  # noqa: E501

        :param wait_url: The wait_url of this Enqueue.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Enqueue):
            return False
