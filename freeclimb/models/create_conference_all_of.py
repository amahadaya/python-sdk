...
class CreateConferenceAllOf(object):
    ...
    def __init__(self, action_url=None, alias=None, play_beep=None, record=None, status_callback_url=None, wait_url=None, local_vars_configuration=None):  # noqa: E501
        """CreateConferenceAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action_url(self):
        """Gets the action_url of this CreateConferenceAllOf.  # noqa: E501
        ...
        :return: The action_url of this CreateConferenceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def action_url(self, action_url):
        """Sets the action_url of this CreateConferenceAllOf.

         This URL is invoked once the Conference is successfully created. Actions on the Conference, such as adding Participants, can be performed via the PerCL script returned in the response.   # noqa: E501

        :param action_url: The action_url of this CreateConferenceAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def alias(self):
        """Gets the alias of this CreateConferenceAllOf.  # noqa: E501

        Descriptive name for the Conference.   # noqa: E501

        :return: The alias of this CreateConferenceAllOf.  # noqa: E501
        :rtype: bool
        """
        return self._alias
    ...
    def alias(self, alias):
        """Sets the alias of this CreateConferenceAllOf.

        Descriptive name for the Conference.   # noqa: E501

        :param alias: The alias of this CreateConferenceAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def play_beep(self):
        """Gets the play_beep of this CreateConferenceAllOf.  # noqa: E501
        ...
        :return: The play_beep of this CreateConferenceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def play_beep(self, play_beep):
        """Sets the play_beep of this CreateConferenceAllOf.

        Indicates whether to play a beep when a Participant enters or leaves the Conference. either `always`, `never`, `entryOnly`, or `exitOnly`. Leaving this unset will make conference default to `always`   # noqa: E501

        :param play_beep: The play_beep of this CreateConferenceAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def record(self):
        """Gets the record of this CreateConferenceAllOf.  # noqa: E501
        ...
        :return: The record of this CreateConferenceAllOf.  # noqa: E501
        :rtype: bool
        """
        return self._record
    ...
    def record(self, record):
        """Sets the record of this CreateConferenceAllOf.

        When set to `true`, the entire Conference is recorded. The `statusCallbackUrl` of the Conference will receive a `conferenceRecordingEnded` Webhook when the Conference transitions from the `inProgress` to empty state.  # noqa: E501

        :param record: The record of this CreateConferenceAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def status_callback_url(self):
        """Gets the status_callback_url of this CreateConferenceAllOf.  # noqa: E501
        ...
        :return: The status_callback_url of this CreateConferenceAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def status_callback_url(self, status_callback_url):
        """Sets the status_callback_url of this CreateConferenceAllOf.

        This URL is invoked when the status of the Conference changes or when a recording of the Conference has become available.  # noqa: E501

        :param status_callback_url: The status_callback_url of this CreateConferenceAllOf.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def wait_url(self):
        """Gets the wait_url of this CreateConferenceAllOf.  # noqa: E501
        ...
        :return: The wait_url of this CreateConferenceAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def wait_url(self, wait_url):
        """Sets the wait_url of this CreateConferenceAllOf.

        If specified, this URL provides the custom hold music for the Conference when it is in the populated state. This attribute is always fetched using HTTP GET and is fetched just once – when the Conference is created. The URL must be an audio file that is reachable and readable by FreeClimb.  # noqa: E501

        :param wait_url: The wait_url of this CreateConferenceAllOf.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateConferenceAllOf):
            return False
