...
class OutDialAllOf(object):
    ...
    def __init__(self, action_url=None, call_connect_url=None, calling_number=None, destination=None, if_machine=None, if_machine_url=None, send_digits=None, status_callback_url=None, timeout=None, privacy_mode=None, local_vars_configuration=None):  # noqa: E501
        """OutDialAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def action_url(self):
        """Gets the action_url of this OutDialAllOf.  # noqa: E501

        URL to which FreeClimb sends an HTTP POST request.   # noqa: E501

        :return: The action_url of this OutDialAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def action_url(self, action_url):
        """Sets the action_url of this OutDialAllOf.

        URL to which FreeClimb sends an HTTP POST request.   # noqa: E501

        :param action_url: The action_url of this OutDialAllOf.  # noqa: E501
        :type: str
        """
    ...
    def call_connect_url(self):
        """Gets the call_connect_url of this OutDialAllOf.  # noqa: E501

        URL to which FreeClimb makes an HTTP POST request informing the result of the OutDial.  # noqa: E501

        :return: The call_connect_url of this OutDialAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def call_connect_url(self, call_connect_url):
        """Sets the call_connect_url of this OutDialAllOf.

        URL to which FreeClimb makes an HTTP POST request informing the result of the OutDial.  # noqa: E501

        :param call_connect_url: The call_connect_url of this OutDialAllOf.  # noqa: E501
        :type: str
        """
    ...
    def calling_number(self):
        """Gets the calling_number of this OutDialAllOf.  # noqa: E501
        ...
        :return: The calling_number of this OutDialAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def calling_number(self, calling_number):
        """Sets the calling_number of this OutDialAllOf.

        he caller ID to show to the called party when FreeClimb calls. This can be one of the following: The To or From number provided in the first Webhook to your webserver. Any phone number you have purchased from FreeClimb.  # noqa: E501

        :param calling_number: The calling_number of this OutDialAllOf.  # noqa: E501
        :type: float
        """
    ...
    def destination(self):
        """Gets the destination of this OutDialAllOf.  # noqa: E501

        E.164 representation of the phone number to Call.   # noqa: E501

        :return: The destination of this OutDialAllOf.  # noqa: E501
        :rtype: float
        """
    ...
    def destination(self, destination):
        """Sets the destination of this OutDialAllOf.

        E.164 representation of the phone number to Call.   # noqa: E501

        :param destination: The destination of this OutDialAllOf.  # noqa: E501
        :type: float
        """
    ...
    @property
    def if_machine(self):
        """Gets the if_machine of this OutDialAllOf.  # noqa: E501
        ...
        :return: The if_machine of this OutDialAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def if_machine(self, if_machine):
        """Sets the if_machine of this OutDialAllOf.

        Specifies how FreeClimb should handle this OutDial if an answering machine answers the Call. Valid values: `redirect` invokes the ifMachineUrl for instructions. `hangup` hangs up the Call. The ifMachineUrl will not be invoked.  # noqa: E501

        :param if_machine: The if_machine of this OutDialAllOf.  # noqa: E501
        :type: str
        """
    ...
    def if_machine_url(self):
        """Gets the if_machine_url of this OutDialAllOf.  # noqa: E501
        ...
        :return: The if_machine_url of this OutDialAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def if_machine_url(self, if_machine_url):
        """Sets the if_machine_url of this OutDialAllOf.

        When the `ifMachine` flag is set to `redirect`, this attribute specifies a URL to which FreeClimb makes a POST request when an answering machine or a fax machine is detected. This URL is required if the `ifMachine` flag is set to `redirect`. Otherwise, it should not be included.  # noqa: E501

        :param if_machine_url: The if_machine_url of this OutDialAllOf.  # noqa: E501
        :type: str
        """
    ...
    def send_digits(self, send_digits):
        """Sets the send_digits of this OutDialAllOf.

        DTMF tones to play to the outdialed Call. This is typically used to dial a number and then dial an extension.  # noqa: E501

        :param send_digits: The send_digits of this OutDialAllOf.  # noqa: E501
        :type: str
        """
    ...
    def status_callback_url(self):
        """Gets the status_callback_url of this OutDialAllOf.  # noqa: E501
        ...
        :return: The status_callback_url of this OutDialAllOf.  # noqa: E501
        :rtype: str
        """
    ...
    def status_callback_url(self, status_callback_url):
        """Sets the status_callback_url of this OutDialAllOf.

        When the outdialed Call leg terminates, FreeClimb sends a `callStatus` Webhook to the `statusCallbackUrl`. This is a notification only; any PerCL command returned is ignored.  # noqa: E501

        :param status_callback_url: The status_callback_url of this OutDialAllOf.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timeout(self):
        """Gets the timeout of this OutDialAllOf.  # noqa: E501
        ...
        :return: The timeout of this OutDialAllOf.  # noqa: E501
        :rtype: int
        """
    ...
    def timeout(self, timeout):
        """Sets the timeout of this OutDialAllOf.

        Maximum time in seconds the `OutDial` command waits for the called party to answer the Call. When a timeout occurs, FreeClimb invokes the `callConnectUrl` Webhook to report that the out-dialed Call has ended with a status of `noAnswer`.  # noqa: E501

        :param timeout: The timeout of this OutDialAllOf.  # noqa: E501
        :type: int
        """
    ...
    def privacy_mode(self):
        """Gets the privacy_mode of this OutDialAllOf.  # noqa: E501

        Parameter `privacyMode` will not log the `text` as required by PCI compliance.  # noqa: E501

        :return: The privacy_mode of this OutDialAllOf.  # noqa: E501
        :rtype: bool
        """
    ...
    def privacy_mode(self, privacy_mode):
        """Sets the privacy_mode of this OutDialAllOf.

        Parameter `privacyMode` will not log the `text` as required by PCI compliance.  # noqa: E501

        :param privacy_mode: The privacy_mode of this OutDialAllOf.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OutDialAllOf):
            return False
